...
graph TD
    subgraph "情報量とエントロピーの概念"
        ...
        subgraph "エントロピー関数の形状"
            BinaryPlot["h(p)<br/>^<br/>1|     ∩<br/> |    / \\<br/> |   /   \\<br/> |  /     \\<br/>0|_/_______\\_<br/> 0   0.5   1  p<br/><br/>最大値: p=0.5 で h(0.5)=1"]
            
            UniformMax["一様分布でエントロピー最大<br/>不確実性が最も高い"]
            DeterministicMin["確定的分布でエントロピー最小<br/>不確実性がない"]
        end
